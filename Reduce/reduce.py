...
def autoencoderBottleneck(dataset, queryset, layers, maxFilters, x, y, convFiltSize, batchSize, epochs, latentDim):
	...
	# bottleneck layer as presented in image provided
	...
	# create model by passing through encoder->bottleneck->decoder structure
	...
	# return concatenated array => we need all entries for query B
...
def reduce(outputDataset, outputQueryset, latentDim, xTrain, xQuery):
	...
	# store latent vectors to write into file, retrieve as latentVector output
